  ...
  <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
    ...
    <div className="mt-5 max-w-2xl text-center mx-auto">
      ...
      Content Generation System -
        <span className="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent"> GenAI</span>
      </h1>
    </div>
    ...
    <div className="mt-5 max-w-3xl text-center mx-auto">
      ...
      Elevate your content creation with our AI-powered app. Generate engaging, high-quality content instantly and gain valuable insights from your data in seconds.</p>
    </div>
    ...
    <div className="mt-8 gap-3 flex justify-center">
      ...
      gap-x-3 text-center bg-gradient-to-tl from-blue-600
       to-pink-600 hover:from-violet-600 hover:to-blue-600 border border-transparent text-white text-sm font-medium rounded-md focus:outline-none focus:ring-1 focus:ring-gray-600 py-3 px-4 dark:focus:ring-offset-gray-800" 
       href="/dashboard">
        Get started
        <svg className="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
      </a>
